...
data = '''The tower is 324 metres (1,063 ft) tall, about the same height as an 81-storey building, 
        ...
        the Eiffel Tower surpassed the Washington Monument to become the tallest man-made structure in the world, a title it held for 41 years until the Chrysler Building in New York City was finished in 1930. 
...
minl=int(input()) # for taking user input
maxl=int(input())
def query(payload):
